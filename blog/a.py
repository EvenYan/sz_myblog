...
class BlogIdcard(models.Model):
    num = models.CharField(max_length=18)
    people = models.ForeignKey('BlogPeople', models.DO_NOTHING, unique=True)

    class Meta:
        managed = False
        db_table = 'blog_idcard'


class BlogPeople(models.Model):
    name = models.CharField(max_length=100)
...
class BlogStudent(models.Model):
    ...
    grade = models.ForeignKey(BlogGrade, models.DO_NOTHING)
